<template>
  <div class="card">
    ...
    <el-collapse >
      <el-collapse-item title="最喜欢的动漫" name="1" style="padding-left: 20px;padding-right: 20px">
        <div>轻音少女、辉夜大小姐想让我告白、青春猪头少年不会梦到兔女郎学姐、路人女主、辉夜大小姐想让我告白、超炮、俺妹</div>
      </el-collapse-item>
      <el-collapse-item title="最喜欢的女孩子" name="2" style="padding-left: 20px;padding-right: 20px">
        <div>樱岛麻衣、亚丝娜、高坂桐乃、五更琉璃、英梨梨、珈百璃、、和泉纱雾</div>
      </el-collapse-item>
      <el-collapse-item title="最喜欢的游戏" name="3" style="padding-left: 20px;padding-right: 20px">
        <div>暂无</div>
      </el-collapse-item>
      <el-collapse-item title="最喜欢的颜色" name="4" style="padding-left: 20px;padding-right: 20px">
        <div>蓝色、紫色</div>
      </el-collapse-item>
